                ...
                <div className={styles.movieform__formsection}>
                    ...
                    <form className={styles.movieform__form} onSubmit={handleSubmit} action="">
                        <div className={styles.movieform__titlegroup}>
                            ...
                            <input className={styles.movieform__forminput} onChange={handleTitle} type="text" value={title} /><br />
                            {/**
                        ...
                        <div className={styles.movieform__dategroup}>
                            ...
                            <input className={styles.movieform__forminput} onChange={handleDate} type="number" value={date} /><br />
                            {/**
                        ...
                        <div className={styles.movieform__picturegroup}>
                            ...
                            <input className={styles.movieform__forminput} onChange={handlePicture} type="text" value={picture} placeholder="Link here" /><br />
                            {/**
                        ...
                        <div className={styles.movieform__genregroup}>
                            ...
                            <select className={styles.movieform__genre} name="genre" id="genre" onChange={handleGenre} value={genre} placeholder="genre">
